...
# class_names = ['BG', 'Hammer', 'person', 'bicycle', 'car', 'motorcycle', 'airplane',
...
model.load_weights(HAMMER_MODEL_PATH, by_name=True)

# img = skimage.io.imread('trained_models/Mask_RCNN/images/sample.jpg')
img = skimage.io.imread('data/train/Hammer0.jpg')
